...
(function($, chrome, document, window){
    ...
    var backgroundPage = chrome.extension.getBackgroundPage(),
        ...
        radiator = {
            ...
            rotate:function(){
                ...
                var animationName = backgroundPage.mmj.getLocalStore("animationName");
                ...
                $('div.radiator').on('webkitAnimationEnd',function(e){
                    ...
                    $('div.radiator').removeClass(animationName).eq( radiator.currentItem ).addClass(animationName);
                })
                if ($('div.radiator').length > 1){
                    $('div.radiator').eq(0).addClass(animationName);
                } else {
    ...
    radiator.init = function( ) {
        ...
        setTimeout(function(){
            var className = 'radiator-count-false'; //+ views.length > 1 ? true : false
