	...
	options = {
		ops:{
			"input":[
				...
				,{"label":"RegExp, long names can be shortened by using a RegExp. e.g. to get the name from an email address you could '([\\\\w|\\\\.]+)@' note the double back slashes!","type":"title","tag":"p"}
			]
		},
		init:function(){
