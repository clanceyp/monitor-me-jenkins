    ...
    var alert = window.alert,
        ...
        options = {
            ...
            jenkinsViewModelInit:function(){
                $("#JenkinsViews_container").html('<table class="data"><tbody data-bind="foreach: jenkinsViews"><tr><td><input type="text" class="displayonly url" data-bind="value: url" /></td><td><img class="displayonly remove" data-bind="click: $root.remove"  src="lib/i/trash.png"/></td><td style="visibility:hidden;"><input type="text" class="displayonly title" data-bind="value: title" /></td></tr></tbody><tfoot><tr><td><img class="displayonly savecolumnconfig" title="save changes" data-bind="click: save" src="lib/i/ok.png"/></td><td><button class="displayonly" data-bind="click: add, enable: jenkinsViews().length < 12">Add view</button></td><td></td></tr></tfoot></table>');
            ...
            JenkinsViewModel:function(){
                var self = this,
                    rawData = backgroundPage.mmj.getLocalStore("JenkinsViews",0,'[{"title":"View name","url":""}]'),
                    ...
                    mappedTasks = $.map(data, function(item, i) {
                        ...
                        return new JenkinsView(item.title ,item.url) ;
                    });
                ...
                function JenkinsView(title, url){
